...
- Creates "fins" using **two coordinate sets**:
  ...
  - **Peak**: `(x, magnitude × scale_factor, z)` - represents force/moment magnitude
...
- Axis titles specify **units**: meters (m) for bridge length, kN for shear force, kN·m for bending moment
...
```
OSDAG/
├── task1_2d_plots.py        # Task 1: 2D SFD/BMD script
├── task2_3d_plots.py        # Task 2: 3D visualization script
├── xarray_data.nc           # Structural analysis dataset
├── node.py                  # Node coordinates dictionary
├── element.py               # Element connectivity dictionary
├── requirements.txt         # Python dependencies
├── README.md                # This file
├── bmd_2d.html             # Generated: 2D BMD (after running Task 1)
├── sfd_2d.html             # Generated: 2D SFD (after running Task 1)
├── bmd_3d.html             # Generated: 3D BMD (after running Task 2)
